...
from usuarios.utils import calcular_idade  # ou função que você já tenha
    ...
    def form_valid(self, form):
        ...
        if idade >= 35:
            ...
            if not perfil or not perfil.bi or not perfil.foto:
                messages.error(self.request, "Complete o Perfil do Cidadão com BI e foto antes de solicitar documentos.")
                return self.render_to_response(self.get_context_data(form=form))
        ...
        # 🔔 Email automático para recenseamento
...
class BaixarPDFDocumentoView(LoginRequiredMixin, View):
    ...
    def get(self, request, documento_id):
        ...
        cabecalho = (
            ...
            "DIRECÇÃO NACIONAL DE RECURSOS HUMANOS<br/>"
